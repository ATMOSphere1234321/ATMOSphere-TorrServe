# QWEN.md — ATMOSphere TorrServe fork
...
ATMOSphere's platform-signed fork of TorrServe (BitTorrent-backed media library/streaming). Built from source by parent scripts/build.sh step_build_torrserve. applicationId atmosphere.torrserve.
